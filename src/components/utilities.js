...
function expressionGenerator(n, level) {
	//the main porpuse of this function is that, given a n number of operations, it returns an arithmetic expression, which the result is always an integer and (likely) positive.
    let  exp = []
    let lastOperator;
		let nIsEven = n % 2 == 0;
